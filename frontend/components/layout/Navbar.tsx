...
export function Navbar() {
  ...
  const liveHref = activeEventId
    ? `/events/${activeEventId}/live`
    : "/events";

  const scriptsHref = activeEventId
    ? `/events/${activeEventId}/scripts`
    : "/events";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          {isAuthenticated && (
            <>
              {/* Operator Badge */}
              <div className="hidden sm:flex items-center gap-2.5 pl-2 border-l border-slate-200 dark:border-[#1e293b]">
              ...
              <button
                ...
                aria-label="Logout"
                title="Logout"
                className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium text-slate-600 dark:text-slate-300 border border-slate-200 dark:border-[#1e293b] hover:bg-rose-500/10 hover:border-rose-500/30 hover:text-rose-600 dark:hover:text-rose-400 transition-colors"
              >
